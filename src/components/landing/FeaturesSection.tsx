...
function FeatureIcon({ name }: { name: string }) {
  ...
  switch (name) {
    case 'chart-network':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v-5.5m3 5.5V8.75m3 2.5V10" /></svg>
    case 'file-chart':
    ...
    case 'package-check':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m6 4.125l2.25 2.25m0 0l2.25-2.25M12 13.875V7.5M3.75 7.5h16.5" /></svg>
    case 'bell-ring':
    ...
    case 'wifi-off':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3 3l18 18M10.5 16.5a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zm-3.22-2.672a8.5 8.5 0 019.44 0m-12.31-3.066a12.5 12.5 0 0115.18 0M1.68 7.896a16.5 16.5 0 0120.64 0" /></svg>
    case 'file-text':
...
export default function FeaturesSection({ title, subtitle, items }: FeaturesSectionProps) {
  ...
  return (
    <section id="funktionen" className="bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div ref={grid.ref} className={`reveal-child grid gap-5 sm:grid-cols-2 lg:grid-cols-4 ${grid.isVisible ? 'visible' : ''}`}>
          {items.map((feature, i) => (
            <div key={feature.title} className="rounded-2xl border border-border bg-white p-6 transition-shadow hover:shadow-md">
              <div className={`mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl ${iconColors[i % iconColors.length]}`}>
